...
public class GameEnd extends StaticScene {
    private LavaExit lavaExit;

    public GameEnd(LavaExit lavaExit){
    ...
    public void setupEntities() {
        ...
        var eindTekst = new Button(new Coordinate2D(getWidth() / 2.5, getHeight() / 1.75), "Go to main", 0, lavaExit);
        addEntity(eindTekst);
    }
}
