...
public class GameLevel extends DynamicScene {
    ...
    public void setupEntities() {
        ...
        Player player = new Player(gewichtText, new Coordinate2D(70, 400), lavaExit);

        Collectible key = new Key(player, new Coordinate2D(530, 150), new Size(100, 50));
        Collectible heavierPowerup = new HeavierPowerup(player, new Coordinate2D(600, 500), new Size(50, 50), 70);
        Collectible springenPowerup = new SpringenPowerup(player, new Coordinate2D(500, 450), new Size(120, 60));

        Door door = new Door((Key) key, player, lavaExit, new Coordinate2D(720, 480), new Size(50, 100));

        Lava lava = new Lava((Key) key, player, lavaExit, new Coordinate2D(0, 580), new Size(800, 800));

        Platform vastPlatform1 = new VastPlatform(new Coordinate2D(50, 550));
        ...
        Platform gewichtPlatform1 = new GewichtPlatform(maxGewichtText1, player, 100, new Coordinate2D(500, 200));
